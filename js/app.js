...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    div.innerHTML = `
                 <div class="col m-3 single-product">
                   <div class="card h-100 class="style="background-color: rgb(241, 241, 221);">
                      <img class="product-image rounded mx-auto d-block m-3" src=${image}></img>
      
                      <div class="card-body">
                         <h5 class="card-title">${product.title}</h5>
                      <p class="card-text">
                         <p>Category: ${product.category}</p>
                         <h2>Price:<span class=" mb-2 class="style="color: rgb(5, 5, 126);"> $ ${product.price} </span></h2>
                         <div class="d-flex justify-content-between my-3">
                         <h5> Rating: <span class="text-danger fw-bold">${product.rating.rate}<span> </h5>
                         <h5><i class="bi bi-file-person"></i> : <span class="text-danger fw-bold">${product.rating.count} </span> </h5>
                         </div>
